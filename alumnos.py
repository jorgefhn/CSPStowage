...
#método que comprueba que las celdas asignadas no son iguales
def notEqual(xi:int,xf:int,yi:int,yf:int):
	return(xi!=xf and yi!=yf)
...
#método que comprueba que la celda inferior está ocupada dada una posición
